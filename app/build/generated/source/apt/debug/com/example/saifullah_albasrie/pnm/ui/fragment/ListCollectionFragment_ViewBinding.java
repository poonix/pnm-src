...
public class ListCollectionFragment_ViewBinding<T extends ListCollectionFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ListCollectionFragment_ViewBinding(T target, View source) {
    this.target = target;

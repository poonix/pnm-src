...
public class ListHistoricalFragment_ViewBinding<T extends ListHistoricalFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ListHistoricalFragment_ViewBinding(T target, View source) {
    this.target = target;

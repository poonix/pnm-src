...
public class FormProspekDetailActivity_ViewBinding<T extends FormProspekDetailActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public FormProspekDetailActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    view = Utils.findRequiredView(source, R.id.btn_email, "field 'btnEmail' and method 'onClick'");
    target.btnEmail = Utils.castView(view, R.id.btn_email, "field 'btnEmail'", Button.class);
    view2131689639 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {

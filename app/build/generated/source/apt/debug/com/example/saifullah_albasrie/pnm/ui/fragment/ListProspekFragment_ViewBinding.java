...
public class ListProspekFragment_ViewBinding<T extends ListProspekFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ListProspekFragment_ViewBinding(T target, View source) {
    this.target = target;

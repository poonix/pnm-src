...
public class ListFeedbackFragment_ViewBinding<T extends ListFeedbackFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ListFeedbackFragment_ViewBinding(T target, View source) {
    this.target = target;

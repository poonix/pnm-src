...
public class ListSurveyFragment_ViewBinding<T extends ListSurveyFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ListSurveyFragment_ViewBinding(T target, View source) {
    this.target = target;

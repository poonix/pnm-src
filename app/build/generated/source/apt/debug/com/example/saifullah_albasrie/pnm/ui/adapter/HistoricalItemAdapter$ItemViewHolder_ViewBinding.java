...
public class HistoricalItemAdapter$ItemViewHolder_ViewBinding<T extends HistoricalItemAdapter.ItemViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public HistoricalItemAdapter$ItemViewHolder_ViewBinding(T target, View source) {
    this.target = target;

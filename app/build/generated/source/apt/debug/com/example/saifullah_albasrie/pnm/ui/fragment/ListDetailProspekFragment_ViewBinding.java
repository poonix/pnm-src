...
public class ListDetailProspekFragment_ViewBinding<T extends ListDetailProspekFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ListDetailProspekFragment_ViewBinding(T target, View source) {
    this.target = target;

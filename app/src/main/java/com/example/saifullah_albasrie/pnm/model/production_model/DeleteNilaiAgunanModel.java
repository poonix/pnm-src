...
public class DeleteNilaiAgunanModel {

    @SerializedName("SV_INDIVIDU_NILAI_AGUNAN_ID")
    @Expose
    public int SV_INDIVIDU_NILAI_AGUNAN_ID;
    ...
    public DeleteNilaiAgunanModel() {}

    public int getSV_INDIVIDU_NILAI_AGUNAN_ID() {
        return SV_INDIVIDU_NILAI_AGUNAN_ID;
    }

    public void setSV_INDIVIDU_NILAI_AGUNAN_ID(int SV_INDIVIDU_NILAI_AGUNAN_ID) {
        this.SV_INDIVIDU_NILAI_AGUNAN_ID = SV_INDIVIDU_NILAI_AGUNAN_ID;
    }

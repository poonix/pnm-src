...
public class DeleteNoteSurveyModel {

    @SerializedName("SV_INDIVIDU_NOTE_ID")
    @Expose
    public int SV_INDIVIDU_NOTE_ID;
    ...
    public DeleteNoteSurveyModel () {}

    public int getSV_INDIVIDU_NOTE_ID() {
        return SV_INDIVIDU_NOTE_ID;
    }

    public void setSV_INDIVIDU_NOTE_ID(int SV_INDIVIDU_NOTE_ID) {
        this.SV_INDIVIDU_NOTE_ID = SV_INDIVIDU_NOTE_ID;
    }

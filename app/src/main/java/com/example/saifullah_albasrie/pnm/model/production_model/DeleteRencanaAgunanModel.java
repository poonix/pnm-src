...
public class DeleteRencanaAgunanModel {

    @SerializedName("SV_INDIVIDU_RENCANA_AGUNAN_ID")
    @Expose
    public int SV_INDIVIDU_RENCANA_AGUNAN_ID;
    ...
    public DeleteRencanaAgunanModel() {}

    public int getSV_INDIVIDU_RENCANA_AGUNAN_ID() {
        return SV_INDIVIDU_RENCANA_AGUNAN_ID;
    }

    public void setSV_INDIVIDU_RENCANA_AGUNAN_ID(int SV_INDIVIDU_RENCANA_AGUNAN_ID) {
        this.SV_INDIVIDU_RENCANA_AGUNAN_ID = SV_INDIVIDU_RENCANA_AGUNAN_ID;
    }

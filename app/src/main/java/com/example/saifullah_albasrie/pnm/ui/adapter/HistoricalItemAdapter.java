...
public class HistoricalItemAdapter extends RecyclerView.Adapter {
    ...
    public HistoricalItemAdapter(List<ProspekListItemModel> listProspek) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            viewHolder.tvVisit.setText(DateUtil.convertDateToNormal(model.getCreatedDate()));

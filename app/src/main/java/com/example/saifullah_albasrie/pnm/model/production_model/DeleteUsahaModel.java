...
public class DeleteUsahaModel {

    @SerializedName("SV_INDIVIDU_USAHA_ID")
    @Expose
    public int SV_INDIVIDU_USAHA_ID;
    ...
    public DeleteUsahaModel() {}

    public int getSV_INDIVIDU_USAHA_ID() {
        return SV_INDIVIDU_USAHA_ID;
    }

    public void setSV_INDIVIDU_USAHA_ID(int SV_INDIVIDU_USAHA_ID) {
        this.SV_INDIVIDU_USAHA_ID = SV_INDIVIDU_USAHA_ID;
    }

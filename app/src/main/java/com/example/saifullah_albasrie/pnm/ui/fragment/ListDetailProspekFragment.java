...
import com.example.saifullah_albasrie.pnm.controller.ListProspekDetailController;
...
import com.example.saifullah_albasrie.pnm.ui.activity.FormProspekDetailActivity;
...
public class ListDetailProspekFragment extends BaseFragment implements OnItemClickListener, ListProspekDetailCallback, AppBarLayout.OnOffsetChangedListener {
    ...
    private ListProspekDetailController controller;
    ...
    private void loadData(boolean clearData) {
        ...
        controller.getProspekDetailList(page);
    }
    ...
    private void initData() {
        ...
        controller = new ListProspekDetailController(this);
    }


    @Override
    public void onItemClick(View itemView, View view, int position, long id) {
        Intent intent = new Intent(getContext(), FormProspekDetailActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == FilterRequestType.FILTER_PROSPEK) {
    ...
    @Override
    public void onGetListProspekDetailSuccess(List<ProspekListItemModel> listItemModels) {
    ...
    @Override
    public void onGetListProspekDetailFailed(Throwable t) {
        DialogFactory.dismissProgress();
        if(!isVisible()) {
            return;
        }

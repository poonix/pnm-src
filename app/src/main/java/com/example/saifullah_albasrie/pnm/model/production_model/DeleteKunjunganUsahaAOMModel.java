...
public class DeleteKunjunganUsahaAOMModel {

    @SerializedName("SV_INDIVIDU_KUNJUNGAN_ID")
    @Expose
    public int SV_INDIVIDU_KUNJUNGAN_ID;
    ...
    public DeleteKunjunganUsahaAOMModel() {}

    public int getSV_INDIVIDU_KUNJUNGAN_ID() {
        return SV_INDIVIDU_KUNJUNGAN_ID;
    }

    public void setSV_INDIVIDU_KUNJUNGAN_ID(int SV_INDIVIDU_KUNJUNGAN_ID) {
        this.SV_INDIVIDU_KUNJUNGAN_ID = SV_INDIVIDU_KUNJUNGAN_ID;
    }
